...
PR['registerLangHandler'](
    ...
    ['css-str']);
/* require 'libs/jquery-1.10.2.min.js' */
...
jQuery(document).ready(function($){
	...
	if($('.article__post')[0]) {
		...
		prettyPrint();
	  // External Link
	  var external_link = $('.article__post').find("a[href^='http']:not([href*='" + location.hostname + "'])");
	  external_link.attr('target', '_blank').append('<i class="fa fa-external-link"></i>');
	}
